  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[70vh] min-h-[500px] overflow-hidden bg-cover bg-center bg-no-repeat" 
               style={{ 
                 backgroundImage: `linear-gradient(rgba(30, 37, 99, 0.7), rgba(30, 37, 99, 0.7)), url(${npHeroImage})`,
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Join our network of Advanced Nurse Practitioners making a difference in patient care.
          </p>
          <Link href="/register">
            <Button 
              size="lg" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-blue-200 mb-6 max-w-md">
                The UK's leading platform for Advanced Nurse Practitioner opportunities. 
