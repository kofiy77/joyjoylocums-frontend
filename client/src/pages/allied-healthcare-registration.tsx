...
import AlliedHealthcareRegistrationForm from "@/components/AlliedHealthcareRegistrationForm";
import { HeartHandshake, ArrowLeft } from "lucide-react";

export default function AlliedHealthcareRegistration() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-8 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link href="/allied-healthcare-professionals" className="inline-flex items-center text-blue-600 hover:text-blue-800">
            <ArrowLeft className="h-4 w-4 mr-2" />
            Back to Allied Healthcare Professionals
          </Link>
        </div>
      </section>
      ...
      <section className="py-12 bg-gradient-to-r from-[#1e2563] to-[#3b4b8c] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl lg:text-5xl font-bold mb-4">
            Allied Healthcare Professional Registration
          </h1>
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Join our network of specialized Allied Healthcare Professionals and connect with NHS opportunities across England.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <AlliedHealthcareRegistrationForm />
      </section>
